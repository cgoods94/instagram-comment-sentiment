...
def extract_comments_from_pk(
    client: Client, media_pk: str, amount: int = 100
) -> pd.DataFrame:
    """Takes an Instagram media pk and dumps
    its comment text, usernames, and timestamps
    into a DataFrame.
    ...
    comments = client.media_comments(media_pk, amount)
